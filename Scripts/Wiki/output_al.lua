      ...
      for _, field in ipairs(fields) do
        ...
        for i, stream_frame in ipairs(stream) do
		  ...
		  elseif field == "Pos" then
            data_string = string.format("x:%d y:%d z:%d", stream_frame.data[1], stream_frame.data[2], stream_frame.data[3])
          else
...
return {
  output = function(obj, where, working, aux)
    ...
    output(obj, where, working, aux or {})
  end,
}
